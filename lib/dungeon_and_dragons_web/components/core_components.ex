defmodule DungeonAndDragonsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DungeonAndDragonsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DungeonAndDragonsWeb.Gettext, "errors", msg, opts)
    end
  end
